...
| 項目 | 内容 |
| --- | --- |
| **問題内容の人手レビュー** | **300問すべて未レビュー。**下記のとおり最優先 |
...
同梱の300問はAIが生成したもので、機械検証（形式・ID重複・問題文の重複・分野と中分類の
...
- **法規**（LEGAL 20問）— 改正が速い領域。現行法との一致を確認する
